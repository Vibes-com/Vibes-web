  ...
  return (
    <div>
      <HeroSection
        ...
        title={
          <h1 className=" pt-0 mt-[-150px] md:mt-[50px] lg:mt-[0px] lg:pt-15 hero-heading font-poppins font-normal text-[32px] sm:text-[60px] md:text-[30px] lg:text-[60px] xl:text-[60px] 2xl:text-[60px] leading-[116%] capitalize text-white">
            Where Careers Take Shape:
            <br />
            <span className=" hero-heading hero-highlight relative z-10 w-fit font-poppins font-semibold text-[32px] sm:text-[65px] md:text-[35px] lg:text-[65px] xl:text-[65px] 2xl:text-[65px] leading-[116%] text-[#F4BE00]">
              Growth at Vibes
            </span>
          </h1>
        }
