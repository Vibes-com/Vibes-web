                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12">
                        <h1 className="font-poppins font-normal hero-heading pt-0 mt-[-150px] lg:mt-[0px] lg:pt-15 text-[32px] sm:text-[60px] md:text-[60px] lg:text-[60px] xl:text-[60px] 2xl:text-[60px] leading-[116%] tracking-normal capitalize text-[#FFFFFF]">
                            ...
                            <br />
                            <span className="hero-highlight hero-heading relative z-9 w-fit font-poppins font-semibold text-[33px] sm:text-[65px] md:text-[65px] lg:text-[65px] xl:text-[65px] 2xl:text-[65px] leading-[116%] tracking-normal capitalize text-[#F4BE00]">Driving Impact.</span>
                        </h1>
                        ...
                        <div className=" mt-4">
                            <Link href="/contact-for-digital-requirements">
                                <Button2 className="mt-5 hidden sm:flex cursor-pointer text-[12px] lg:text-[18px]  p-[10px] lg:p-[20px] hover:border-[#2B4C69] hover:border-[2px] hover:text-[#F4BE00] hover:bg-transparent bg-[#FFFFFF] text-[#204667]">
