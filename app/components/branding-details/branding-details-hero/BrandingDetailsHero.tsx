                    ...
                    <div className="col-span-12">
                        ...
                        <div className=" mt-4">
                            <Link href="/contact-for-digital-requirements">
                                <Button2 className="mt-5 cursor-pointer text-[12px] lg:text-[18px]  p-[10px] lg:p-[20px] hover:border-[#2B4C69] hover:border-[2px] hover:text-[#F4BE00] hover:bg-transparent bg-[#FFFFFF] text-[#204667]">
