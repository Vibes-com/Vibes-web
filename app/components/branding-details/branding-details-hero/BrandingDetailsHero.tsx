            ...
            <div className="container mx-auto max-w-screen-xl px-4 md:px-8">
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12">
                        ...
                        <p className="mt-10 font-poppins font-semibold text-[13px] sm:text-[18px] md:text-[18px] lg:text-[18px] xl:text-[18px] 2xl:text-[18px] leading-[128%] tracking-normal capitalize text-[#FFFFFF] md:max-w-[400px]  lg:max-w-2xl">
                            From insight to identity, built for business impact
                        </p>
                        <div className=" mt-4">
                            <Link href="/contact-for-digital-requirements">
                                <Button2 className=" mt-0 lg:mt-5  md:hidden lg:flex sm:flex cursor-pointer text-[12px] lg:text-[18px]  p-[10px] lg:p-[20px] hover:border-[#2B4C69] hover:border-[2px] hover:text-[#F4BE00] hover:bg-transparent bg-[#FFFFFF] text-[#204667]">
