  ...
  return (
    <div>
      ...
      <AboutSection
        ...
        features={[
          {
            icon: "/assests/img/digital-m-details/on-page-seo.png",
            title: <>On-Page SEO</>,
          ...
          {
            icon: "/assests/img/digital-m-details/off-page-seo.png",
            title: <>Off-Page SEO</>,
          ...
          {
            icon: "/assests/img/digital-m-details/technical-seo.png",
            title: <>Technical SEO</>,
          ...
          {
            icon: "/assests/img/digital-m-details/ai.png",
          ...
          {
            icon: "/assests/img/digital-m-details/keyword.png",
