            ...
            <div className="container mx-auto max-w-screen-xl px-4 md:px-8">
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 ">
                        ...
                        <p className="mt-10 font-poppins font-semibold text-[13px] sm:text-[18px] md:text-[18px] lg:text-[18px] xl:text-[18px] 2xl:text-[18px] leading-[128%] tracking-normal capitalize text-[#FFFFFF] md:max-w-[400px] lg:max-w-[500px]">
                        ...
                        <div className="mt-4 lg:mt-9 max-w-7xl me-auto flex sm:flex  md:hidden lg:flex  md:flex-row items-center justify-center gap-5 w-max">
