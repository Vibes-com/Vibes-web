...
const DigitalMarketingDetailsHero: React.FC = () => {
    return (
        <div className="digital-details-hero-wrapper flex items-center h-[90vh]">
                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 ">
                        <h1 className="font-poppins font-normal hero-heading pt-0 mt-[-150px] md:mt-[50px] lg:mt-[0px] lg:pt-15 text-[32px] sm:text-[60px] md:text-[30px] lg:text-[60px] xl:text-[60px] 2xl:text-[60px] leading-[116%] tracking-normal capitalize text-[#FFFFFF]">
                            ...
                            <br />
                            <span className="hero-highlight hero-heading relative z-9 w-fit font-poppins font-semibold text-[33px] sm:text-[65px] md:text-[35px] lg:text-[65px] xl:text-[65px] 2xl:text-[65px] leading-[116%] tracking-normal capitalize text-[#F4BE00]"> Growth Forward</span>
                        </h1>
                        ...
                        <p className="mt-10 font-poppins font-semibold text-[14px] sm:text-[18px] md:text-[18px] lg:text-[18px] xl:text-[18px] 2xl:text-[18px] leading-[128%] tracking-normal capitalize text-[#FFFFFF] md:max-w-[400px] lg:max-w-[500px]">
                            Smart strategies designed to scale reach, leads, and conversions
...
export default DigitalMarketingDetailsHero;
